...
## M1 delivered — 14 September 2026
Playable standalone yard, trolley/winch pendulum, physical drop and rehook, barrier collision, settled-release acceptance, pointer/keyboard controls, pause/reset, and browser regression harness implemented. Deterministic success and recovery routes pass. See PLAYTEST.md for actual verification and remaining human-testing limitations.
